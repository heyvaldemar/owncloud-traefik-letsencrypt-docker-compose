...
- **`owncloud/server:11.0.0` was rebuilt upstream**; the pin moved from `sha256:e5a90c2f9f11…` to `sha256:63fbab9cf49d…`. Same version, same tag, a rebuilt base image — the usual shape of a security fix in a base layer.

## [1.8.5] - 2026-09-13

### Security

- **`owncloud/server:11.0.0` was rebuilt upstream**; the pin moved from `sha256:bb83a4db4dc2…` to `sha256:e5a90c2f9f11…`. Same version, same tag, a rebuilt base image — the usual shape of a security fix in a base layer.

## [1.8.4] - 2026-09-11

### Security

- **`owncloud/server:11.0.0` was rebuilt upstream**; the pin moved from `sha256:bc35331d71ed…` to `sha256:bb83a4db4dc2…`. Same version, same tag, a rebuilt base image — the usual shape of a security fix in a base layer.
...
- **`owncloud/server:11.0.0` was rebuilt upstream**; the pin moved from `sha256:667c772de235…` to `sha256:bc35331d71ed…`. Same version, same tag, a rebuilt base image — the usual shape of a security fix in a base layer.
...
- **A shutdown grace period for MariaDB and Redis.** Docker stops a container with
...
[Unreleased]: https://github.com/heyvaldemar/owncloud-traefik-letsencrypt-docker-compose/compare/v1.8.13...HEAD
...
[1.8.4]: https://github.com/heyvaldemar/owncloud-traefik-letsencrypt-docker-compose/compare/v1.8.3...v1.8.4
[1.8.2]: https://github.com/heyvaldemar/owncloud-traefik-letsencrypt-docker-compose/compare/v1.8.1...v1.8.2
[1.8.1]: https://github.com/heyvaldemar/owncloud-traefik-letsencrypt-docker-compose/compare/v1.8.0...v1.8.1
[1.8.0]: https://github.com/heyvaldemar/owncloud-traefik-letsencrypt-docker-compose/compare/v1.7.0...v1.8.0
[1.7.0]: https://github.com/heyvaldemar/owncloud-traefik-letsencrypt-docker-compose/compare/v1.6.0...v1.7.0
[1.6.0]: https://github.com/heyvaldemar/owncloud-traefik-letsencrypt-docker-compose/compare/v1.5.0...v1.6.0
[1.5.0]: https://github.com/heyvaldemar/owncloud-traefik-letsencrypt-docker-compose/compare/v1.4.0...v1.5.0
[1.4.0]: https://github.com/heyvaldemar/owncloud-traefik-letsencrypt-docker-compose/compare/v1.3.0...v1.4.0
[1.3.0]: https://github.com/heyvaldemar/owncloud-traefik-letsencrypt-docker-compose/compare/v1.2.1...v1.3.0
